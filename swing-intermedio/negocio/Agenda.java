...
public class Agenda {
    ...
    public ArrayList<Persona> buscar(String inicio){
        ArrayList<Persona> seleccionados = new ArrayList();
        /* Recorre la lista de contactos */
        for(Persona alguien : this.contactos){
            if (alguien.getNombre().startsWith(inicio)){
                seleccionados.add(alguien);
            }
        }
